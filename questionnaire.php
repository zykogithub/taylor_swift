...
<main>
    ...
    if ($nb_point  ===  20) {
        ...
        <form  action='video.php' method='post' >
            <input id='video' type = 'password' placeholder="form : DD/MM/YYYY" name='video_1'><label for='video'>Type your date of birth for a special gift</label><br>
            <input type='submit'>
            <input type='reset'>
        </form>
        <?php
    ...
    elseif ($nb_point >= 15) {
        echo "<h1 id = 'presque'>Almsot but not perfect. You aren't a big fan I think". "\nYou're mark is : ". $nb_point . " on 20";
        echo"<img src='presque.gif'>";
    }
    elseif ($nb_point > 10) {
        echo "<h1 id = 'moyenne'>You are average, Be happy because the majority of people haven't average like you. And I think you noticed it but 5 questions didn't come from the biography." . "\n You're mark is : ". $nb_point . "on 20";
    ...
    elseif ($nb_point  ===  0) {
        echo"<h1 id = 'dommage'> Sadly, you have 0 good answer . Read the biography again and come back later" . "\n You're mark is : ". $nb_point . " on 20 ";
